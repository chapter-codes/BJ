...
export { default as businessName } from './business-name.svg'
...
export { default as church } from './success.svg'
export { default as business } from './compressed/business.webp'
export { default as clippedBrandIcon } from './clipped-brand-icon.svg'
